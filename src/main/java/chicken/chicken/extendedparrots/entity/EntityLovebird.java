...
{
	private static final DataParameter<Integer> texture = EntityDataManager.<Integer>createKey(EntityLovebird.class, DataSerializers.VARINT);
	...
	private static final Predicate<EntityLiving> field_192014_bH = new Predicate<EntityLiving>()
	{
        ...
        {
        	return p_apply_1_ != null && EntityLovebird.field_192017_bK.containsKey(EntityList.getID(p_apply_1_.getClass()));
        }
    };
