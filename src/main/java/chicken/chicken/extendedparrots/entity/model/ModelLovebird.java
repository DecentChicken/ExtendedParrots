...
/**
 * ModelLovebird - Mojang with minor edit by DecentChicken
 * Created using Tabula 7.0.1
 */
public class ModelLovebird extends ModelBase
{
    ...
    private ModelLovebird.State state = ModelLovebird.State.STANDING;

    public ModelLovebird() {
    		...
    		float headPitch, float scaleFactor, Entity entityIn) 
    {
        ...
        if (this.state != ModelLovebird.State.FLYING)
        {
            if (this.state == ModelLovebird.State.SITTING)
            {
                return;
            }

            if (this.state == ModelLovebird.State.PARTY)
            {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        if (entitylivingbaseIn instanceof EntityParrot)
        {
            ...
            if (entityparrot.isPartying()) 
            {
                ...
                this.state = ModelLovebird.State.PARTY;
                return;
            }
